...
<div class="form-group"><label class="col-md-12 nopl">Владение языками</label>
				<div class="col-md-12 nopl">		
					<?$langs = array('русский','английский','немецкий','китайский')?>

				<!--select name="lang" class="multiple-select2 form-control" multiple="multiple"-->
					<?foreach ($langs as $lang):?>
						<input name="lang[]" <?if (strpos($data->lang,$lang) !== false):?>checked<?endif?> value="<?=$lang?>" type="checkbox" style="position:relative;top:2px"> <label class="m-r-15"><?=$lang?></label>
					<?endforeach?>
				<!--/select-->
				</div>
						</div>
