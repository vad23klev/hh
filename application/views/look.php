...
<br/>
								...
								<input type="submit" class="buttone1_long" value="Подтвердить заказ">
<a href="<?=URL::site()?>order/form" class="buttone_long">Изменить данные</a>
<a href="<?=URL::site()?>" class="buttone1_long">Продолжить шопинг</a>
<br/><br/>
