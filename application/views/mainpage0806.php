...
<div id="news" class="content" data-scrollview="true">
			...
			<h2 class="content-title">Новости</h2>
					...
					<div class="col-md-12 col-sm-12">
						...
						<li class="active"><a href="#default-tab-1" data-toggle="tab">Новости ВЭД</a></li>
						<li class=""><a href="#default-tab-2" data-toggle="tab">Анонсы мероприятий</a></li>
						<li class=""><a href="#default-tab-3" data-toggle="tab">Экспертное мнение</a></li>
						<li class=""><a href="#default-tab-4" data-toggle="tab">Аналитика</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane fade active in" id="default-tab-1">
							<?$news1 = ORM::factory('new')->where('enabled','=',1)->where('category_id','=',385)->find_all()?>
							...
							<?for ($i=0;$i < $lim;$i++) {?>
								<div class="col-md-3 col-sm-3">
										<?if (strlen($news1[$i]->picture)>0) :?>
											<img src="/resize/resizer.php?image=<?=$news1[$i]->picture?>&width=250&height=150&type=news&method=auto" border="0">
										<?endif?>                               
										<p class="desc"><?=$news1[$i]->name?><br/>
											<a href="#modal-<?=$news1[$i]->id?>" data-toggle="modal" class="link1">Подробнее...</a>
										</p>					
										<?require "modal_news.php"?>
									...
									<?for ($i==6;$i < $lim;$i++) {?>
										<div class="media media-sm">
											<a class="media-left" href="javascript:;">
												<img src="/op/assets/img/user-1.jpg" alt="" class="media-object">
											</a>
											<div class="media-body">
												<h4 class="media-heading"><?=$news1[$i]->name?></h4>
												<a href="#modal-<?=$news1[$i]->id?>" data-toggle="modal" class="link1">Подробнее...</a>
											</div>
										</div>
										<?require "modal_news.php"?>
						...
						<div class="tab-pane fade" id="default-tab-2">
								<?$news1 = ORM::factory('new')->where('enabled','=',1)->where('category_id','=',386)->find_all()?>
						...
						<div class="tab-pane fade" id="default-tab-3">
							<?$news1 = ORM::factory('new')->where('enabled','=',1)->where('category_id','=',387)->find_all()?>
						...
						<div class="tab-pane fade" id="default-tab-4">
							...
							<?for ($i=0;$i < 4;$i++) {?>
								<div class="col-md-3 col-sm-3">
									<!--img src="/main/e1.jpg" /-->                            
									<p><small><?$cur = strtotime($xml->channel->item[$i]->pubDate)?><?=date('d.m.Y',$cur)?></small></p>									
									<p class="desc"><?=$xml->channel->item[$i]->title?></p>										
									<a href="<?=$xml->channel->item[$i]->link?>">подробнее ...</a>
								</div>
							<?}?>
							<div class="clearfix"></div>
							
							<?for ($i=5;$i < 11;$i++) {?>
									<div class="media media-sm col-md-6 col-sm-6">
									<!--a class="media-left" href="javascript:;">
										<img src="/op/assets/img/user-1.jpg" alt="" class="media-object">
									</a-->
									<div class="media-body">
										<h4 class="media-heading"><?=$xml->channel->item[$i]->title?></h4>
										<p><small><?$cur = strtotime($xml->channel->item[$i]->pubDate)?><?=date('d.m.Y',$cur)?></small></p>
...
<div class="col-md-9 col-sm-9">
        ...
        <div id="contact1" class="content" data-scrollview="true">
            <!-- begin container -->
            <div class="container">
                <h2 class="content-title">На нашей платформе работают</h2>
