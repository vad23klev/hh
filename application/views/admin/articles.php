...
<strong><a href="<?=URL::site()?>admin/aarticles?page=<?=$page1?>">К списку статей</a></strong><br/><br/>
...
//        $CKEditor->basePath = $url."ckeditor/";
        ...
        echo form::open(URL::site()."admin/articles?page=".$page1,array('method'=>'POST','enctype' => 'multipart/form-data'));
        ...
        print "<tr><td width='200'>\n";
        print "<b>Рефтинг для России в рейтингах<br/> (через , - год, место, мест всего, повышение = 1/понижение = 0): </b>\n";
        print "</td><td>\n";
        print form::input('ratings', $page->ratings);
        print "</td></tr>\n";
