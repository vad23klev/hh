<a href="/admin/shops?<?=$cstr?>&id=<?=$cid->id?>"><?=$cid->name?></a>
<br/><br/>
	<?php
        print form::open(URL::site()."/admin/shopimgs/?".$cstr."&cid=".$cid,array('method'=>'POST','enctype' => 'multipart/form-data'));
...
<?foreach ($goods as $good) :?>
	    <?php
        print form::open(URL::site()."/admin/shopimgs/?cid=".$cid,array('method'=>'POST','enctype' => 'multipart/form-data'));
        ...
        print "<img src='".URL::site()."img/shopphotos/".$good->name."' width='100px'><br/>";
		
		print "<a href='".URL::site()."admin/shopimgs/?".$cstr."&cid=".$cid."&del&id=".$good->id."'>Удалить фото</a>";
        print "</td>";
