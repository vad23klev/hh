...
<form method="POST" id="jq137" action="/admin/cabinet?user=<?=$data->id?>">
		...
		<div class="ti">		
		<input type="text"  class="fld" name="fullname"  value="<?=$data->fullname?>">
		</div>

		<div class="cont_form_name">Краткое наименование <span>*</span></div>
		<div class="ti">		
		<input type="text"  class="fld" name="shortname"  value="<?=$data->shortname?>">
		</div>
...
<div style="clear:both"></div>
		...
		<select name="role">
		<?$roles = array(1=>'пользователь',3=>'оператор',4=>'провайдер услуги',2=>'администратор')?>
	...
	<form method="POST" id="jq137" action="/admin/cabinet?user=<?=$data->id?>">
		...
		<div class="ti">		
		<input type="text"  class="fld" name="login"  value="<?=$data->user->username?>">
		</div>
