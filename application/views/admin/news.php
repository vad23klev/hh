...
//        $CKEditor->basePath = $url."ckeditor/";
        ...
        print "<tr><td width='200'>\n";
        print "<b>Наименование источника: </b>\n";
        print "</td><td>\n";
        print form::input('sname', $page->sname);
        print "</td></tr>\n";


        print "<tr><td width='200'>\n";
        print "<b>Ссылка на источник: </b>\n";
        print "</td><td>\n";
        print form::input('slink', $page->slink);
        print "</td></tr>\n";
		
        print "<tr><td width='200'>\n";
        print "<b>Теги (через ,): </b>\n";
        print "</td><td>\n";
        print form::input('tags', $page->tags);
        print "</td></tr>\n";		
