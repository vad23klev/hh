...
Вы успешно выставили лот N <?=sprintf('%06d',$prod->id)?> &quot;<?=$prod->name?>&quot; на торги.<br />
<?endif?>

<?if ($state==0):?>
Здравствуйте, Администратор сайта BID-BID.<br />
Был создан новый лот N <?=sprintf('%06d',$prod->id)?> &quot;<?=$prod->name?>&quot; пользователя N <?=sprintf('%06d',$prod->user_id)?>.<br />
Пользователь <?=sprintf('%06d',$prod->user_id)?> успешно выставил лот N <?=sprintf('%06d',$prod->id)?> &quot;<?=$prod->name?>&quot; на торги.<br />
<br />
<?endif?>
