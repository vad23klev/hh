...
Ваш профиль на сайте НП "ПРОВЭД" прошел авторизацию. Теперь Вам доступны все сервисы портала.
<br/><br/>
<a href="http://<?=$_SERVER['HTTP_HOST']?>/user/cabinet">ВОЙТИ В ЛИЧНЫЙ КАБИНЕТ</a>		
<br/><br/>
С уважением,
<br/>
НП «ПРОВЭД»
