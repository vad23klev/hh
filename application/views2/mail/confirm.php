Здравствуйте, <strong><?=$user['fio']?></strong>!<br/><br/>
Вы успешно зарегистрировались на сайте НП «ПРОВЭД» в статусе «<?=$role?>». <br/><br/>

Ваш профиль еще не авторизован. Для авторизации Вам необходимо заполнить все поля Вашего профиля, отмеченные как обязательные для заполнения.
<br/><br/>

Данные для входа в Ваш личный кабинет:   <br/><br/>

<b>Логин:</b> <?=$user['username']?><br/>
<b>Пароль:</b> <?=$password?><br/><br/>
Для перехода в личный кабинет Вы можете воспользоваться ссылкой <br/>
<a href="http://<?=$_SERVER['HTTP_HOST']?>/user/cabinet">http://<?=$_SERVER['HTTP_HOST']?>/user/cabinet</a><br/>		
<br/><br/>
С уважением,
<br/>
НП «ПРОВЭД»
