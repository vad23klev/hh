...
<br />
Вы успешно изменили данные лота N <?=sprintf('%06d',$prod->id)?> &quot;<?=$prod->name?>&quot;.<br />
<?endif?>

<?if ($state==0):?>
Здравствуйте, Администратор сайта BID-BID.<br />
Данные лота <?=sprintf('%06d',$prod->id)?> &quot;<?=$prod->name?>&quot; пользователя N <?=sprintf('%06d',$prod->user_id)?> были изменены.<br />
<br />
<?endif?>
