...
<table>
<tr><td colspan="4">
<a href="<?=URL::site()?>admin/teams">Добавить команду</a><br/>
</td>
</tr>
...
<td>
	<a href="<?=URL::site()?>admin/teams?id=<?=$prod->id?>"><?=$prod->name?></a><br/>
</td>
<td>
	
</td>
<td>
<a href="<?=URL::site()?>admin/teams/?del=1&page=<?=$page?>&id=<?=$prod->id?>" onclick="javascript:return confirm('Вы уверены?')"><img src="/img/del.gif" border="0"/></a>
</td>
</tr>
<?endforeach?>
...
<?php
        ...
        echo form::open(URL::site()."admin/teams",array('method'=>'POST','enctype' => 'multipart/form-data'));
