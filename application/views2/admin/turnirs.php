...
<table>
<tr><td colspan="4">
<a href="<?=URL::site()?>admin/turnirs">Добавить турнир</a><br/>
</td>
</tr>
...
<td>
	<a href="<?=URL::site()?>admin/turnirs?id=<?=$prod->id?>"><?=$prod->name?></a><br/>
</td>
<td>
	
</td>
<td>
<a href="<?=URL::site()?>admin/turnirs/?del=1&page=<?=$page?>&id=<?=$prod->id?>" onclick="javascript:return confirm('Вы уверены?')"><img src="/img/del.gif" border="0"/></a>
</td>
</tr>
<?endforeach?>
...
<?php
        ...
        echo form::open(URL::site()."admin/turnirs",array('method'=>'POST','enctype' => 'multipart/form-data'));
...
//		print "<img src='/img/turnir/".$page1->picture."'>";
		print "</tr></table>";
